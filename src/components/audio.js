    ...
    return (
        <>
            ...
            <div className={`flex items-center justify-center my-4 ${className}`}>
                <button onClick={playAudio} disabled={!ready} className={`relative shadow-lg focus:outline-none transition transform active:scale-95 h-32 w-32 flex items-center justify-center rounded-full ${playing ? 'bg-red-500 text-white' : 'border-red-500 text-red-500 border-4'}`}>
